...
import { Plus, Edit, Trash2, Building, MapPin, Info } from 'lucide-react';
import api from '../api';
                        ...
                        <table style={{width:'100%', borderCollapse:'collapse'}}>
                            <thead style={{background:'#f8fafc', borderBottom:'1px solid #e2e8f0'}}>
                                <tr>
                                    ...
                                    <th style={{padding:16, textAlign:'center', fontSize:'0.85rem', color:'#64748b', textTransform:'uppercase', width:'120px'}}>Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                {ruangan.length === 0 ? (
                                        ...
                                        <tr key={idx} style={{borderBottom:'1px solid #f1f5f9'}}>
                                            ...
                                            <td style={{padding:16}}>
                                                <div style={{display:'flex', alignItems:'center', justifyContent:'center', gap: 8}}>
                                                    ...
                                                    {/* Tombol Hapus */}
                                                    <button 
                                                        onClick={() => handleDelete(r.ruangan_id)} 
                                                        title="Hapus Ruangan"
                                                        style={{
                                                            background: '#fef2f2', 
