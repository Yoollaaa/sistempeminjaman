...
import { 
    ...
    Loader, Download, Filter, ChevronRight, AlertCircle 
} from 'lucide-react';

const Riwayat = () => {
    const [activeTab, setActiveTab] = useState('Semua');

    // DATA DUMMY (Status: pending, process, success, error)
    const historyData = [
        { 
            id: 1, 
            ruangan: 'Lab Sistem Kendali (H5)', 
            tgl: '25 Nov 2025', 
            jam: '08:00 - 10:00', 
            keperluan: 'Kelas Pengganti - Sistem Kendali Lanjut',
            status: 'Menunggu Verifikasi', 
            step: 1, // Tahap 1 dari 3
            type: 'pending' 
        },
        { 
            id: 2, 
            ruangan: 'Ruang Kuliah Teori (H20)', 
            tgl: '01 Des 2025', 
            jam: '13:00 - 15:00', 
        ...
        { 
            id: 3, 
            ruangan: 'Lab Jaringan (H19)', 
            tgl: '15 Okt 2025', 
            jam: '09:00 - 11:00', 
            keperluan: 'Rapat Himpunan',
            status: 'Ditolak', 
            step: 3, 
            note: 'Bentrok dengan jadwal praktikum rutin.',
            type: 'error' 
        },
        { 
            id: 4, 
            ruangan: 'Ruang Sidang (H3)', 
            tgl: '28 Nov 2025', 
            jam: '10:00 - 12:00', 
            keperluan: 'Bimbingan Kelompok',
            status: 'Diverifikasi Admin', 
            step: 2, // Tahap 2 (Sedang di Admin/Kajur)
            type: 'process' 
        }
    ];
    ...
    const getStatusStyle = (type) => {
        switch(type) {
            ...
            case 'process': return { border: '#0284c7', bgBadge: '#e0f2fe', textBadge: '#0369a1', icon: <Loader size={16} className="animate-spin"/> }; 
        ...
        <div className="app-layout">
            ...
            <div className="content-container">
                ...
                <div style={{marginBottom: 30}}>
                    <h1 style={{fontSize:'2rem', fontWeight:800, color:'#0f172a', margin:'0 0 5px 0'}}>Status Pengajuan</h1>
                    <p style={{color:'#64748b', margin:0}}>Pantau progres persetujuan peminjaman ruangan Anda secara real-time.</p>
                </div>
                                    ...
                                    {item.type === 'error' && (
                                        <div style={{background:'#fef2f2', padding:12, borderRadius:8, border:'1px solid #fecaca', display:'flex', gap:10}}>
                                            ...
                                            <div>
                                                ...
                                                <p style={{margin:0, fontSize:'0.85rem', color:'#b91c1c'}}>{item.note}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
